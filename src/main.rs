...
use nexellia_miner::PluginManager;
use log::{error, info};
...
async fn main() -> Result<(), Error> {
    ...
    let (app, mut plugin_manager): (App, PluginManager) = nexellia_miner::load_plugins(Opt::into_app(), &plugins)?;
